						...
						<div class="columns is-multiline">
							<div v-for="(street, key) in game.streetController.enabledStreets" :key="key"							
								...
								<div class="button is-medium relative" v-on:click="switchStreet(side, street)"
									...
									<span
										v-if="street.config.coinName !== 'CELO' && street.config.coinName !== 'Bitcoin' && street.config.coinName !== 'Ethereum' && street.config.coinName !== 'Arbitrum One' && street.config.coinName !== 'Manta' && street.config.coinName !== 'Bitcoin Cash' && street.config.coinName !== 'Litecoin' && street.config.coinName !== 'LUKSO' && street.config.coinName !== 'Monero'  && street.config.coinName !== 'SOL'" 
										class="soon">Coming soon</span>
										<!-- <span
										v-if="street.config.coinName !== 'Bitcoin' && street.config.coinName !== 'Arbitrum One' && street.config.coinName !== 'CELO' && street.config.coinName !== 'LUKSO' && street.config.coinName !== 'Ethereum' && street.config.coinName !== 'Bitcoin Cash' && street.config.coinName !== 'Litecoin' && street.config.coinName !== 'CELO' && street.config.coinName !== 'Monero'" 
